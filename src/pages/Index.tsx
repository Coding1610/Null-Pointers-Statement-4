...
import { ArrowRight, Zap, MapPin, BarChart3, Settings, Shield, Globe2, LogIn, Menu } from 'lucide-react';
    ...
    <div className="min-h-screen bg-background">
          ...
          <div className="md:hidden">
            <Sheet>
              <SheetTrigger asChild>
                <Button variant="outline" size="sm" className="border-white/20 text-black hover:bg-white">
      ...
      <header className="relative overflow-hidden bg-gradient-primary">
        ...
        <div className="relative z-10 container mx-auto px-4 md:px-6 py-16 md:py-24">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <p className="text-base md:text-xl text-white/90 mb-6 md:mb-8 max-w-2xl mx-auto leading-relaxed px-4">
            ...
            <div className="flex flex-col sm:flex-row gap-3 md:gap-4 justify-center px-4">
              {user ? (
                <Button 
                  size="lg" 
                  variant="secondary" 
                  className="bg-white text-primary hover:bg-white/90 shadow-energy w-full sm:w-auto" 
                  onClick={() => navigate('/map')}
                >
                  Launch Map Platform
                ...
                <Button 
                  size="lg" 
                  variant="secondary" 
                  className="bg-white text-primary hover:bg-white/90 shadow-energy w-full hover:text-black sm:w-auto" 
                  onClick={() => navigate('/auth')}
                >
                  Get Started
                  <ArrowRight className="ml-2 h-5 w-5" />
              ...
              <Button size="lg" variant="outline" className="border-white/20 text-primary hover:bg-white w-full sm:w-auto">
      ...
      <section className="py-16 md:py-24 bg-gradient-primary relative overflow-hidden">
        ...
        <div className="relative z-10 container mx-auto px-4 md:px-6 text-center">
          ...
          <Button size="lg" variant="secondary" className="bg-white hover:text-black text-primary hover:bg-white/90 shadow-energy w-full sm:w-auto max-w-xs" onClick={() => navigate('/map')}>
            Start Planning Now
            <ArrowRight className="ml-2 h-5 w-5" />
          </Button>
        </div>
